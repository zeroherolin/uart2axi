...
module uart2axi_uart2axi_Pipeline_VITIS_LOOP_84_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln1027_1_reg_169;
wire   [0:0] icmp_ln1027_1_reg_169_pp0_iter0_reg;
reg    ap_predicate_op30_write_state2;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_CS_iter1_fsm_state2;
wire   [0:0] icmp_ln1027_1_fu_117_p2;
wire   [0:0] icmp_ln1027_fu_105_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    tx_data_blk_n;
wire   [0:0] trunc_ln87_fu_139_p1;
reg   [0:0] trunc_ln87_reg_183;
wire   [63:0] zext_ln87_fu_133_p1;
reg   [10:0] i_V_fu_54;
wire   [10:0] add_ln840_fu_111_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_i_V_1;
wire   [7:0] p_0_fu_148_p4;
wire   [8:0] lshr_ln2_fu_123_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_187)) begin
        if (((icmp_ln1027_fu_105_p2 == 1'd0) & (icmp_ln1027_1_fu_117_p2 == 1'd1))) begin
            i_V_fu_54 <= add_ln840_fu_111_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start_int == 1'b0) | ((ap_predicate_op30_write_state2 == 1'b1) & (tx_data_full_n == 1'b0) & (1'b1 == ap_CS_iter1_fsm_state2))) & (icmp_ln1027_fu_105_p2 == 1'd0) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
        icmp_ln1027_1_reg_169 <= icmp_ln1027_1_fu_117_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_start_int == 1'b0) | ((ap_predicate_op30_write_state2 == 1'b1) & (tx_data_full_n == 1'b0) & (1'b1 == ap_CS_iter1_fsm_state2))) & (icmp_ln1027_fu_105_p2 == 1'd0) & (icmp_ln1027_1_fu_117_p2 == 1'd1) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
        trunc_ln87_reg_183 <= trunc_ln87_fu_139_p1;
    end
end
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((ap_predicate_op30_write_state2 == 1'b1) & (tx_data_full_n == 1'b0) & (1'b1 == ap_CS_iter1_fsm_state2))) & (1'b1 == ap_CS_iter0_fsm_state1) & ((icmp_ln1027_fu_105_p2 == 1'd1) | (icmp_ln1027_1_fu_117_p2 == 1'd0)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter0_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_i_V_1 = i_V_fu_54;
    end
end
...
always @ (*) begin
    case (ap_CS_iter1_fsm)
        ap_ST_iter1_fsm_state2 : begin
            ...
            end else if (((~((ap_predicate_op30_write_state2 == 1'b1) & (tx_data_full_n == 1'b0)) & (1'b1 == ap_CS_iter1_fsm_state2) & ((icmp_ln1027_1_reg_169_pp0_iter0_reg == 1'd0) | (icmp_ln1027_reg_165_pp0_iter0_reg == 1'd1))) | (~((ap_predicate_op30_write_state2 == 1'b1) & (tx_data_full_n == 1'b0)) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_start_int == 1'b1)))) begin
...
assign add_ln840_fu_111_p2 = (ap_sig_allocacmp_i_V_1 + 11'd1);
...
always @ (*) begin
    ap_predicate_op30_write_state2 = ((icmp_ln1027_1_reg_169 == 1'd1) & (icmp_ln1027_reg_165 == 1'd0));
end

assign icmp_ln1027_1_fu_117_p2 = ((mul_i_i > ap_sig_allocacmp_i_V_1) ? 1'b1 : 1'b0);

assign icmp_ln1027_1_reg_169_pp0_iter0_reg = icmp_ln1027_1_reg_169;

assign icmp_ln1027_fu_105_p2 = ((ap_sig_allocacmp_i_V_1 == 11'd1024) ? 1'b1 : 1'b0);

assign icmp_ln1027_reg_165_pp0_iter0_reg = icmp_ln1027_reg_165;

assign lshr_ln2_fu_123_p4 = {{ap_sig_allocacmp_i_V_1[9:1]}};

assign trunc_ln87_fu_139_p1 = ap_sig_allocacmp_i_V_1[0:0];

assign tx_data_din = p_0_fu_148_p4;

assign uart_buffer_V_1_address0 = zext_ln87_fu_133_p1;

assign uart_buffer_V_address0 = zext_ln87_fu_133_p1;

assign zext_ln87_fu_133_p1 = lshr_ln2_fu_123_p4;

endmodule //uart2axi_uart2axi_Pipeline_VITIS_LOOP_84_7
