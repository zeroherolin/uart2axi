...
- UART上位机软件，如Windows平台的XCOM.exe[XCOM_V2.2.exe](assets/XCOM_V2.2.exe)（注意必须将收发模式设为16进制表示）

## Synthesis

将全部verilog文件[verilog_code](verilog_code)拷贝至工程目录
...
最后的```11 11 11 11 22 22 22 22 33 33 33 33 44 44 44 44 55 55 55 55 66 66 66 66 77 77 77 77```表示写数据```0x00000000 0x11111111 0x22222222 0x33333333 0x44444444 0x55555555 0x66666666 0x77777777```
